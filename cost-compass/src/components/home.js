...
function Home(){
    return (
        ...
        <div className="paragraph" id="overlay" onclick="hideOverlay()">
            ...
            <a>© Developed by TheNivedha, CostCompass is your go-to resource for easy to access financial data is.</a>
